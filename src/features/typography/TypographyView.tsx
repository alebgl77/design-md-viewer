            ...
            return (
              ...
              >
                ...
                <div className="text-[11px] font-mono text-content-muted flex flex-wrap gap-4">
                  <span>Family: <strong className="text-content-primary">{token.fontFamily}</strong></span>
                  <span>Pixels: <strong className="text-content-primary tabular-nums">{token.fontSizePx}px</strong></span>
                  {token.letterSpacing && <span>Tracking: <strong className="text-content-primary tabular-nums">{token.letterSpacing}</strong></span>}
                </div>
              </div>
            );
          })}
            ...
            {typography.map((token) => (
              <div key={token.id} className="pt-4 flex flex-col md:flex-row items-start md:items-baseline justify-between gap-4">
                <div className="w-44 shrink-0 font-mono text-xs text-content-secondary">
                  ...
                  <div className="text-[11px] text-content-muted tabular-nums">{token.fontSize} ({token.fontSizePx}px)</div>
                </div>
